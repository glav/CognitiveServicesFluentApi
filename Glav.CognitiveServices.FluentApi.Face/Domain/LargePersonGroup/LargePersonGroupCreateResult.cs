...
{
    public class LargePersonGroupCreateResult : BaseApiResponseReturnsData<LargePersonGroupCreateResponseRoot, LargePersonGroupCreateResponseRoot, LargePersonGroupCreateResponseRoot>
    {
